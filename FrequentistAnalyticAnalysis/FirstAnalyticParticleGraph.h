#ifndef FREQUENTIST_ANALYTIC_ANALYSIS_FIRSTANALYTICPARTICLEGRAPH_H
#define FREQUENTIST_ANALYTIC_ANALYSIS_FIRSTANALYTICPARTICLEGRAPH_H
#include <string_view>
#include <vector>
#include "Bin.h"
	...
	normalizationFactor(channelReader.getChannelsRead())
{
	...
	//Normalization does not do anything, so the normalization parts are commented out
